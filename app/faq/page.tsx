    ...
    ctx: () => (
      <div key={`Step_2`} className="grid-item grid-2">
        ...
        <div className="grid-item-content">
          Next.ID will generate a unique message for you to sign. You sign this
          message using your Next.ID private key, which is a process that can
          usually be handled by your Next.ID private key. This generates a
    ...
    ctx: () => (
      <div key={`Step_3`} className="grid-item grid-3">
        ...
        <div className="grid-content">
          ...
          signature publicly on your selected social media account. This could
          be in the form of a tweet, or it could be added to your profile
          information. This serves as a public declaration linking your Next.ID
          to your Web2 social account.
        </div>
      </div>
    ),
  },
  {
    ...
    ctx: () => (
      <div key={`Step_4`} className="grid-item grid-4">
        ...
        <div className="grid-content">
          The platform then checks your Twitter account for the presence of this
          signature and validates it against the original message using your
          Ethereum public address. If it matches, it proves that the owner of
          the Ethereum address is the same as the Twitter account owner.
        </div>
      </div>
    ),
  },
    ...
    ctx: () => (
      <div key={`Step_5`} className="grid-item grid-5">
        ...
        <div className="grid-content">
          ...
          between your Ethereum address and your Twitter account. This record
          serves as a part of your digital identity
        </div>
      </div>
    ),
  },
...
export default function FAQ() {
  ...
  const FAQRenderMap = [
        ...
        <div className="faq-body">
          ...
          <div className="faq-row">
            ...
            <div className="paragraph">
              A technical standard is a collectively agreed-upon set of
              guidelines and specifications that enable interoperability and
              consistent implementation of a particular technology or service,
              allowing different entities to effectively communicate or build
              upon it. In other words, a group of people getting together and
              deciding to build something in a certain way. For example, Gmail &
              Yahoo are popular email services that adhere to guidelines on how
              emails are transmitted, formatted, and delivered across different
              email systems. These guidelines ensure that emails can be
              exchanged and understood between various email providers, allowing
              for interoperability in the broader email ecosystem.
            </div>
          </div>
          <div className="faq-row">
            <div className="badge">DID Standard</div>
            <div className="paragraph">
              Decentralized identity, also known as self-sovereign identity, is
              an identity framework based on open standards. It utilizes digital
    ...
    },
    {
      ...
      title: () => (
        <div className="faq-title">
          How does <span>Next.ID</span> make the connection between Web2 and
          Web3 identities?
        </div>
      ),
      content: () => (
    ...
    },
    {
      ...
      title: () => (
        <div className="faq-title">Any support for more chains?</div>
      ),
      content: () => (
        <div className="faq-body">
          <div className="paragraph">
            Next.ID now supports the Ethereum mainnet and plans to go
            multi-chain, to name a few, ETH L2s, Solana, Polygon, Near, and
            other L1s. Going multi-chain will be key for protocol growth and
            user adoption.
          </div>
        </div>
      ),
      ...
      content: () => (
        <div className="faq-body">
          <div className="paragraph">
            ...
            partner of choice of Mask Network and also a Mask ecosystem
            protocol. It’s developed by Dimension tech which has 3 branches,
            namely Mask Network, Next.ID, Firefly. The Next.ID team now has
            around 10 people working on it, most of them are developers who have
            years of experience in Web2 and Web3.
          </div>
          <div className="faq-row">
      ...
      content: () => (
        <div className="faq-body">
          <div className="paragraph">
            ...
            through Next.ID protocol can be queried through a publicly
            accessible API. The data is stored in Arweave.
          </div>
        </div>
      ),
    },
